...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu đẹp trai quá ik ༼ つ ❤_❤ ༽つ ";
...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Nói cho tớ lí do cậu thích tớ đi (^・ω・^ )',
        html: true,
        width: 900,
        padding: '3em',
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Tối nay tớ qua đón cậu đi chơi nhaaaaaaaaa :3 Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàoooooo 😘",
